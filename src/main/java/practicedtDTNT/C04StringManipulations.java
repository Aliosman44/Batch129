...
public class C04StringManipulations {
    public static void main(String[] args) {
        ...
        System.out.println("Yüz"+40+60);//Yuz4060
        System.out.println("yüz"+(40+60));//yuz100
        System.out.println("ikiyüzkırk"+40*60);// ikiyüzkırk240
        System.out.println(60+40+"yuz");//100yuz

        //Kullanıcıdan ismini soyismini girmesini isteyin. Kullanıcı nasıl girerse girsin tam ismini büyük harfle
        ...
        String tamİsim= isim.concat(""+soyad).toUpperCase();
        System.out.println("tam isim="+ tamİsim);

        //verilen cümleyi **** ile gizleyip 10. karakterden sonrasını yazdırın.

        String cümle= "Her dert Java gibi olsa";
        String c1= cümle.replaceAll("\\w", "*")+ cümle.substring(10);
        System.out.println(c1);

        //a harfini @işareti ile değiştir.
        String ders= "olağanüstü";

        String s1= ders.replace("a","@");
        System.out.println(s1);

//verilen bir String dekullanılan noktalama işareti ve rakamlar ve space karakteri hariç tüm
// karakterlerin sayısını bulan kodu yazınız.
